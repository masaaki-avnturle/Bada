...
final class Emit {
    ...
    // ---- C ----
    private static String tc(Type t) { return t == Type.DOUBLE ? "double" : t == Type.STRING ? "const char*" : "int"; }
    ...
    static String c(Program p, Map<String, Type> types) {
        ...
        types.forEach((v, t) -> out.add("  " + tc(t) + " " + v + " = " + (t == Type.STRING ? "\"\"" : "0") + ";"));
    ...
    private static List<String> cFunc(Func f, Map<String, Type> types) {
        ...
        for (Stmt s : f.body()) o.addAll(cStmt(s, 1, types));
        o.add("}");
        return o;
    }
    ...
    // ---- Java ----
    private static String tj(Type t) { return t == Type.DOUBLE ? "double" : t == Type.STRING ? "String" : "int"; }
    ...
    static String java(Program p, Map<String, Type> types) {
        ...
        types.forEach((v, t) -> out.add("    " + tj(t) + " " + v + " = " + (t == Type.STRING ? "\"\"" : "0") + ";"));
    ...
    private static List<String> javaFunc(Func f, Map<String, Type> types) {
        ...
        for (Stmt s : f.body()) o.addAll(javaStmt(s, 1, types));
        o.add("}");
        return o;
    }
