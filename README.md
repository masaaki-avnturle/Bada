...
| **`bada_fuga/`** | 🎼 **Contrapunctus BADA** — アップロード音源 (MOTHER / LOVELESS / トラック 8・17・18 / 録音 2 本) から抽出したモチーフで作曲した、コントラプンクトゥス XIV 風の三重フーガ (B-A-D-A 主題) · 4 声加算合成 · ピアノロール mp4 · 作曲/合成/動画スクリプト | [→ 開く](bada_fuga/) |
