...
## 🎼 ダウンロード — Bada Fusion Suite(Fuga · Requiem · Ave Verum · Acceptance)

**バッハのフーガとレクイエム(半音階の嘆きのバスによるパッサカリア)、モーツァルト《アヴェ・ベルム・コルプス》の「ほっと一安心」、坂本龍一《Sweet Revenge》《鉄道員》《Acceptance (Little Buddha)》の様式を、アップロードされた 16 本の録音と合成した 6 楽章・約 7 分の組曲(MP4)。** 旋律・和声はすべてオリジナルで、依存最小(numpy / scipy / Pillow / ffmpeg)の加算合成シンセ(ピアノ / 弦 / 母音フォルマント合唱 / オルガン / 鐘 / ドローン + 畳み込みリバーブ)が作曲・演奏・録画まで自動生成する。第 III 楽章が E7 のまま止まり、第 IV 楽章の F major へ偽終止で「光が差し込む」構成。

### 👉 [**fusion_suite/bada_fusion_suite.mp4 をダウンロード**](fusion_suite/bada_fusion_suite.mp4)
