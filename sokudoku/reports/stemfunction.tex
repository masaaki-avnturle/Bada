...
\usepackage{amssymb}
\begin{document}
\title{Global topology transport from monotonicity \\
and singularity of complex manifold. \\
Component of manifold in differential and integral \\
from quantum level of deprivate equation.}
...
\maketitle
   ...
   $$ \left({{\int f(x) dx} \over \log x}\right) = \lim_{\theta \to \infty}
    ...
    constant of equations.
       Therefore, this calicurate function resore with result of
     seed of two in three manifold of dimension.
 ...
 カルーツァ・クライン空間の方程式は、
  ...
  閉３次元多様体は、種数は２となり、固有値とホモロジー多様体、特異点が
  同時に計算できる結果にもいけることがわかる。
