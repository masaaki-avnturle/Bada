 ...
 *
 * The program creates the directory (default "omega_causal_pkg" or argv[1]) and
 * writes files under bin/, lib/, include/, etc/, usr/share/omega/, and a top-level Makefile.
 *
 * The generated Makefile is written to avoid common shell errors (quotes, paths).
 */
...
"help:\n"
  ...
  /* There are embedded tabs and newlines; write carefully */
