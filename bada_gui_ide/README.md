...
| ファイル | 内容 |
|:---|:---|
| [`dist/atom-critical.html`](dist/atom-critical.html) | ★ シミュレータ本体 (単一 HTML)。14 元素 (Pd・Pu 含む) · λ 200–4000 nm · I₀ 10¹¹–10¹⁸ W/cm² · CSV/JSON/PNG 出力 |
...
> 仮定します。閉殻 d¹⁰ の Pd、開殻 5f を持つアクチノイドの Pu では、多電子相関や
> 相対論効果を含まないぶん近似が粗くなります。また Pd の第 4 電離以降、Pu の
> 第 2 電離以降の `I_p` は推定値です。アプリは該当元素を選ぶとこの注意書きを
> パネルに表示します。
