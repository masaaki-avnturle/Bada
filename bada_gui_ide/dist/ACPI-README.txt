...
何を計算しているか:
  ...
  対応元素 (15): H He Li Be C N O Ne Na Ar Kr Pd Xe U Pu (各 1-5 電離段)。
           ...
           U は [Rn]5f^3 6d^1 7s^2、Pu は [Rn]5f^6 7s^2 でいずれも最外殻 7s
           (l=0)。第一 I_p は Pu 6.03 eV < U 6.19 eV で本表の最小 2 つ、
           臨界強度も 5.27e12 / 5.89e12 W/cm^2 と最小。
           ADK は水素様 n* と単一活性電子を仮定するため、閉殻 d10 の Pd と
           開殻 5f の U・Pu では近似が粗くなる (アプリが注意書きを表示)。
           本モデルは同位体を区別しない (障壁抑制もトンネル電離も同位体シフト
           に対して非選択的)。
