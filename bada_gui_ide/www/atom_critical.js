...
(function (root, factory) {
  ...
  var ELEMENTS = [
    ...
    { sym: "U",  name: "ウラン",     Z: 92, l: 0, Ip: [6.1941, 14.7200, 19.6900, 32.6000, 46.0000],
      note: "基底配置 [Rn]5f³6d¹7s² — 最外殻は 7s (l=0)。第一 I_p = 6.19 eV は Pu に次いで低く、" +
            "臨界強度は 5.89×10¹² W/cm²。第 2 電離以降の I_p は文献により幅があり " +
            "(第 2 電離で 10.6–14.7 eV)、本表は CRC Handbook の値を採用。" +
            "Pu と同じく開殻 5f を持つアクチノイドで、ADK が仮定する水素様 n* と単一活性電子から" +
            "のずれが大きい (多電子相関・相対論効果は未考慮)。" },
