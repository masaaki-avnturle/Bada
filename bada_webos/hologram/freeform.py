...
def html_freeform(catalog: list, tb: int) -> str:
    return _TEMPLATE.replace("__CATALOG__", json.dumps(catalog, ensure_ascii=False)) \
...
<div id="menu"><h4>アプリ &#9638;</h4><div id="grid"></div></div>
<div id="taskbar">
...
function toggleMenu(s){menu.style.display=(s===undefined?(menu.style.display==='none'?'block':'none'):(s?'block':'none'));}
